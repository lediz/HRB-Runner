...
{ "ARRAYVALUE3", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( ARRAYVALUE3 )}, NULL },
{ "DATEVALUE", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( DATEVALUE )}, NULL },
{ "DATEVALUETIME", {HB_FS_PUBLIC | HB_FS_LOCAL}, {HB_FUNCNAME( DATEVALUETIME )}, NULL }
...
HB_FUNC( ARRAYVALUE3 )
{
	static const HB_BYTE pcode[] =
	{
		13,1,0,36,19,0,92,2,92,3,3,2,0,80,
		1,36,20,0,95,1,110,7
	};
...
HB_FUNC( DATEVALUE )
{
	static const HB_BYTE pcode[] =
	{
		36,21,0,134,240,132,37,0,110,7
	};
